...
这里保存本人素材及明确反馈的来源边界。本人素材表只迁移一条可在项目参考文件中逐字找到的用户原话：本人拥有并使用过 Pocket，允许在本人备选稿中轻微使用有依据的使用感受。其他表达反馈已分布在[原句对照](../aesthetics/feedback.md)与下方共享风格来源中；确认范围和历史调整统一见[上下文](../context/README.md)，不能把本表仅1条理解成整库只有1条反馈。

- [records.jsonl](records.jsonl)：1 条明确原话、记录日期、来源定位、可确认事实和未知项。原聊天未重新打开，证据状态写明“项目文件保存的用户原话”。
- [source-register.jsonl](source-register.jsonl)：区分本人素材、项目写作规则、编辑案例、自写验收稿及历史检查记录；各文件保留 SHA256。
