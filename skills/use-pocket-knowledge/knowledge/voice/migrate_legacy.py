...
def make_feedback():
    ...
    sources = [
        ...
        {"id": "feedback_source_project_skill", "source_path": ".agents/skills/write-pocket-seeding-comments/SKILL.md", "source_kind": "project_writing_rule", "use": "继续作为op项目写作与验收规则入口", "is_platform_comment_corpus": False, "is_user_acceptance_of_generated_drafts": False},
